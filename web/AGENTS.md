...
- Night-theme switches that are off but available use a visibly lighter blue-gray track and a bright thumb so they read as interactive; disabled switches remain distinguished by reduced opacity.
